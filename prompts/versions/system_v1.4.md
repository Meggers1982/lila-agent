...
Before proposing visual directions, read `/skills/image-assets/SKILL.md` **once per session only**. It contains the format catalog (dimensions, layout pivots) and the aesthetic register reference. Follow it exactly. Do not rely on memory for format specs.

If you have already read it earlier in this session, proceed without re-reading it — cite what you already know.
